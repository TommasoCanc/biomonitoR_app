fluidRow(
  ...
  column(width = 4,
         ...
         box(title = "Functional dispersion", width = NULL, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
             ...
             selectInput("f_disp.tax_lev", "Taxa level", 
                         choices = c("Family" = "Family", 
                                     "Genus" = "Genus", 
                                     "Species" = "Species", 
                                     "Taxa" = "Taxa"), 
                         selected = "Taxa", multiple = FALSE),
             selectInput("f_disp.type", "Variable type", 
                         choices = c("Fuzzy" = "F",
                                     "Continuous" = "C"), 
             ...
             selectInput("f_disp.prec", "Prec",choices = c("Qt" = "Qt",
                                                           "Qj" = "Qj"), 
         ...
         box(title = "Functional diversity", width = NULL, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
             checkboxInput("funDivs", label = "Functional diversity", value = FALSE), # Functional diversity
             selectInput("f_divs.tax_lev", "Taxa level", 
                         choices = c("Family" = "Family", 
                                     "Genus" = "Genus", 
                                     "Species" = "Species", 
                                     "Taxa" = "Taxa"), 
                         selected = "Taxa", multiple = FALSE),
             selectInput("f_divs.type", "Variable type", 
                         choices = c("Fuzzy" = "F",
                                     "Continuous" = "C"), 
                         selected = "F", multiple = FALSE),
             checkboxInput("f_divs.traitSel", label = "Trait selection", value = FALSE), 
             # col_blocks
             selectInput("f_divs.distance", "Functional distance", 
                         choices = c("Euclidean" = "euclidean",
                                     "Gower" = "gower"), 
                         selected = "euclidean", multiple = FALSE),
             checkboxInput("f_divs.zerodist_rm", label = "Zero distance", value = FALSE),
             selectInput("f_divs.correction", "Correction method", 
                         choices = c("None" = "none",
                                     "Lingoes" = "lingoes", 
                                     "Cailliez" = "cailliez", 
                                     "Square Root" = "sqrt", 
             ...
             selectInput("f_divs.prec", "Prec",choices = c("Qt" = "Qt",
                                                        "Qj" = "Qj"), 
                         selected = "Qj", multiple = FALSE),
         ...
         box(title = "Functional evenness", width = NULL, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
             ...
             selectInput("f_eve.tax_lev", "Taxa level", 
                         choices = c("Family" = "Family", 
                                     "Genus" = "Genus", 
                                     "Species" = "Species", 
                                     "Taxa" = "Taxa"), 
                         selected = "Taxa", multiple = FALSE),
             selectInput("f_eve.type", "Variable type", 
                         choices = c("Fuzzy" = "F",
                                     "Continuous" = "C"), 
                         selected = "F", multiple = FALSE),
             ...
             selectInput("f_eve.distance", "Functional distance", 
                         choices = c("Euclidean" = "euclidean",
                                     "Gower" = "gower"), 
                         selected = "euclidean", multiple = FALSE),
             checkboxInput("f_eve.zerodist_rm", label = "Zero distance", value = FALSE),
             selectInput("f_eve.correction", "Correction method", 
                         choices = c("None" = "none",
                                     "Lingoes" = "lingoes", 
                                     "Cailliez" = "cailliez", 
                                     "Square Root" = "sqrt", 
             ...
             selectInput("f_eve.prec", "Prec",choices = c("Qt" = "Qt",
                                                        "Qj" = "Qj"), 
                         selected = "Qj", multiple = FALSE),
         ...
         box(title = "Functional redundancy", width = NULL, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
             ...
             selectInput("f_red.tax_lev", "Taxa level", 
                         choices = c("Family" = "Family", 
                                     "Genus" = "Genus", 
                                     "Species" = "Species", 
                                     "Taxa" = "Taxa"), 
                         selected = "Taxa", multiple = FALSE),
             selectInput("f_red.type", "Variable type", 
                         choices = c("Fuzzy" = "F",
                                     "Continuous" = "C"), 
                         selected = "F", multiple = FALSE),
             checkboxInput("f_red.traitSel", label = "Trait selection", value = FALSE), 
             # col_blocks
             selectInput("f_red.distance", "Functional distance", 
                         choices = c("Euclidean" = "euclidean",
                                     "Gower" = "gower"), 
                         selected = "euclidean", multiple = FALSE),
             checkboxInput("f_red.zerodist_rm", label = "Zero distance", value = FALSE),
             selectInput("f_red.correction", "Correction method", 
                         choices = c("None" = "none",
                                     "Lingoes" = "lingoes", 
                                     "Cailliez" = "cailliez", 
                                     "Square Root" = "sqrt", 
             ...
             selectInput("f_red.prec", "Prec",choices = c("Qt" = "Qt",
                                                       "Qj" = "Qj"), 
                         selected = "Qj", multiple = FALSE),
         ...
         box(title = "Functional richness", width = NULL, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
             ...
             selectInput("f_rich.tax_lev", "Taxa level", 
                         choices = c("Family" = "Family", 
                                     "Genus" = "Genus", 
                                     "Species" = "Species", 
                                     "Taxa" = "Taxa"), 
                         selected = "Taxa", multiple = FALSE),
             selectInput("f_rich.type", "Variable type", 
                         choices = c("Fuzzy" = "F",
                                     "Continuous" = "C"), 
                         selected = "F", multiple = FALSE),
             ...
             selectInput("f_rich.distance", "Functional distance", 
                         choices = c("Euclidean" = "euclidean",
                                     "Gower" = "gower"), 
                         selected = "euclidean", multiple = FALSE),
             checkboxInput("f_rich.zerodist_rm", label = "Zero distance", value = FALSE),
             selectInput("f_rich.correction", "Correction method", 
                         choices = c("None" = "none",
                                     "Lingoes" = "lingoes", 
                                     "Cailliez" = "cailliez", 
                                     "Square Root" = "sqrt", 
             ...
             selectInput("f_rich.prec", "Prec",choices = c("Qt" = "Qt",
                                                       "Qj" = "Qj"), 
                         selected = "Qj", multiple = FALSE),
  ...
  column(width = 8,
         ...
         conditionalPanel("input.funDivs == 1",
                          box(width = NULL, solidHeader = TRUE,
                              HTML("<h3> Functional dispersion </h3>"), 
                              DTOutput("tbl_f_divs"),
         ...
         conditionalPanel("input.funRed == 1",
                          box(width = NULL, solidHeader = TRUE,
         ...
         conditionalPanel("input.funRich == 1",
                          box(width = NULL, solidHeader = TRUE,
